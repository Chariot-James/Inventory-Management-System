    ...
    try:
        ...
        <body>
            <div class="header">
                ...
                <p>Mom's Inventory Management System - MongoDB Edition</p>
            </div>
        ...
        html_content += f"""
            ...
            <div class="footer">
                <p>Generated by Mom's Inventory Management System (MongoDB Edition) on {report_date}</p>
...
def generate_order_html():
    ...
    html_content += f"""
        ...
        <div class="footer">
            <p>Generated by Mom's Inventory Management System (MongoDB Edition) on {order_date}</p>
...
# --- UI ---
st.title("Mom's Inventory Management System - MongoDB Edition")
...
with st.sidebar:
    ...
    if inventory_collection is not None:
        ...
        st.caption("Daily automatic backups enabled")
    else:
